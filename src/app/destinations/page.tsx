...
export const metadata: Metadata = {
  ...
  description: "Explore amazing destinations with Royal Journey Tours Kashmir.",
  alternates: {
          ...
          <div className="grid lg:grid-cols-2">
            ...
            <div className="flex flex-col justify-center p-10">
              ...
              <p className="mt-6 text-slate-600">
                Experience majestic mountains, serene lakes, beautiful gardens,
                and unforgettable adventures in one of the world's most scenic
                destinations.
              </p>
            </div>
          </div>
            ...
            >
              ...
              <div className="p-6">
                ...
                <a
                  ...
                  className="mt-6 block w-full rounded-xl bg-slate-900 py-3 text-center text-white hover:bg-cyan-600"
                >
                  View Details
                </a>
              </div>
      ...
      <section className="bg-gradient-to-r from-cyan-600 to-blue-700 py-24">
        <div className="mx-auto max-w-4xl px-6 text-center text-white">
          ...
          <p className="mt-6 text-lg text-cyan-100">
            Let us help you find the perfect destination based on your budget,
